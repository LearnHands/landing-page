...
// ── Atomic components ─────────────────────────────────────────────────────────
const ObjectiveItem = ({ icon, title }: { icon: React.ReactNode; title: string }) => (
...
export default function Welcome() {
  return (
    <>
      <Head title="LearnHands — Aprendizaje sin Mouse" />
      <div className="min-h-screen bg-[#03030b] text-white selection:bg-purple-500/30 font-sans overflow-x-hidden scroll-smooth relative">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative z-10">
          ...
          {/* ── Navbar ──────────────────────────────────────────────────────── */}
          <nav className="fixed top-0 w-full z-50 bg-black/60 backdrop-blur-xl py-4 px-8 flex justify-between items-center border-b border-white/5">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-sans text-xl tracking-tighter font-black uppercase">LearnHands</span>
              </div>
            </div>
            <div className="hidden md:flex gap-8 text-xs font-black uppercase tracking-widest text-white/40 items-center">
              ...
              <a href="/hub" className="px-6 py-2 bg-purple-600 text-white rounded-full font-bold hover:bg-purple-500 transition-all text-[9px] uppercase tracking-widest flex items-center gap-2">
          ...
          <header className="relative pt-48 pb-24 px-8 flex flex-col items-center text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
              className="mb-6 px-5 py-1.5 bg-black/40 backdrop-blur-sm rounded-full border border-white/10 text-[9px] font-black uppercase tracking-[0.35em] text-purple-400 flex items-center gap-2">
              <span className="w-1.5 h-1.5 bg-purple-400 rounded-full animate-pulse" />
              Fe y Alegría Ecuador · Plataforma Educativa
            </motion.div>

            <h1 className="text-6xl md:text-8xl font-sans leading-[0.95] mb-8 font-black tracking-tighter italic bg-gradient-to-r from-purple-400 via-white to-cyan-400 bg-clip-text text-transparent uppercase">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-24 font-black uppercase tracking-widest text-xs">
              ...
              <a href="/hub" className="px-10 py-5 bg-white/5 backdrop-blur-sm rounded-3xl flex items-center gap-3 border border-white/10 hover:border-white/30 transition-all">
                Probar Demo Web
              </a>
            </div>

            {/* Preview card */}
            <section className="w-full max-w-4xl rounded-[40px] overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm p-1 relative shadow-2xl shadow-purple-500/10">
              <div className="bg-white/5 rounded-[38px] overflow-hidden p-12 text-center">
                ...
                <div className="aspect-video bg-black/40 rounded-3xl border border-white/5 flex items-center justify-center relative overflow-hidden">
                  ...
                  <a href="/hub" className="absolute bottom-10 px-8 py-3 bg-purple-600 rounded-xl font-bold text-xs uppercase tracking-widest z-10 hover:scale-105 transition-all">
                    Abrir Demo Web →
                  </a>
                </div>
              </div>
          ...
          <section id="mision" className="py-24 px-8 max-w-5xl mx-auto scroll-mt-20">
            <h2 className="text-3xl md:text-5xl font-sans font-black mb-12 text-center underline decoration-purple-500 decoration-4 underline-offset-[12px] uppercase italic">
              Misión e Inclusión
            </h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-[40px] border border-white/10 space-y-4">
          ...
          <section id="modulos" className="py-24 px-8 max-w-7xl mx-auto scroll-mt-20">
            <h2 className="text-center text-4xl font-sans font-black mb-4 italic bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent tracking-tighter uppercase">
            ...
            <div className="flex justify-center">
              <a href="#descarga" className="px-8 py-3 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 text-[10px] font-black uppercase tracking-widest text-white/50 hover:text-white hover:border-white/30 transition-all flex items-center gap-2">
          ...
          <section id="descarga" className="py-32 px-8 scroll-mt-20 relative">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center mb-20">
                ...
                <h2 className="text-4xl md:text-6xl font-sans font-black italic tracking-tighter uppercase mb-6 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
                  Versión Completa
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                  ...
                  <a href={DESKTOP_REPO} target="_blank" rel="noreferrer"
                    className="flex items-center gap-3 px-8 py-5 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-white/30 text-[10px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-20">
                <div className="bg-white/5 backdrop-blur-sm rounded-[36px] border border-white/10 overflow-hidden">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-[36px] border border-purple-500/30 overflow-hidden shadow-2xl shadow-purple-500/10 relative">
              ...
              <div className="text-center mb-12">
                <h3 className="text-2xl md:text-3xl font-sans font-black italic uppercase tracking-tighter mb-3">Los 10 Módulos</h3>
              ...
              {/* Requirements */}
              <div className="mt-16 bg-white/5 backdrop-blur-sm rounded-[36px] border border-white/10 p-8 grid sm:grid-cols-3 gap-8 text-center">
                {[
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-4 items-stretch justify-center">
                {[
                  ...
                  <div key={step.n} className="flex-1 bg-white/5 backdrop-blur-sm rounded-[28px] border border-white/10 p-6 flex flex-col gap-3 text-center">
                    <span className="text-4xl font-sans font-black italic bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent opacity-60">{step.n}</span>
          ...
          <footer className="py-20 border-t border-white/5 text-center text-white/10 text-[10px] font-black uppercase tracking-[0.4em] flex flex-col items-center gap-6 px-8">
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <a href={RELEASES_URL} target="_blank" rel="noreferrer"
                className="hover:text-white transition-colors flex items-center gap-3 bg-white/5 backdrop-blur-sm px-6 py-3 rounded-full border border-white/5 text-white/30">
                <Download size={14} /> Descargar App Escritorio
              </a>
              <a href={GITHUB_LINK} target="_blank" rel="noreferrer"
                className="hover:text-white transition-colors flex items-center gap-3 bg-white/5 backdrop-blur-sm px-6 py-3 rounded-full border border-white/5">
